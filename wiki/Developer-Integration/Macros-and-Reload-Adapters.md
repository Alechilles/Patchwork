...
Patchwork 1.4.1 sends exactly one target expectation in each adapter request, even though the request shape is a list for future compatibility. Return exact target lists for reloaded, restart-required, and failed outcomes.
