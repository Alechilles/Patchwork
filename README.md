...
Patchwork 1.3.2 supports these installation modes:

*   Install `patchwork-standalone-1.3.2.jar` as a Hytale server mod.
*   Embed `com.alechilles:patchwork-runtime:1.3.2` in another Java plugin.

Patchwork 1.3.2 contributes its own hosted Alec's Telemetry project transitively through
