...
- Reduced repeated Windows filesystem checks during safe generated-pack path
  validation. Patchwork self-tests and generation no longer spend minutes
  rescanning trusted server-root ancestors.
